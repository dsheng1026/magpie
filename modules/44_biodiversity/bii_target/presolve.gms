...
if (m_year(t) = s44_start_year AND i44_bii_target(i,biome44) > 0,
...
* The target value for the linear interpolation is the lower bound defined in `i44_bii_target(i,biome44)`.
