...
scalars
  ...
  s60_bioenergy_1st_subsidy first generation bioenergy subsidy (USD17MER per GJ) / 0 /
  s60_bioenergy_1st_price first generation bioenergy per-GJ price (USD17MER per GJ) / 45 /
  s60_bioenergy_2nd_price second generation bioenergy price (USD17MER per GJ) / 45 /
  s60_2ndgen_bioenergy_dem_min Minimum dedicated 2nd generation bioenergy demand assumed in each region during SSP2-fix (mio. GJ per yr) / 0 /
;

$setglobal c60_price_implementation  lin
$setglobal c60_2ndgen_biodem  MESSAGE_SSP2_historical_BE
$setglobal c60_2ndgen_biodem_noselect  MESSAGE_SSP2_historical_BE
