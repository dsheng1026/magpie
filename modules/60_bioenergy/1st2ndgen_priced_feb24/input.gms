...
scalars
  ...
  s60_bioenergy_1st_price first generation bioenergy per-GJ price (USD17MER per GJ) / 7 /
  s60_bioenergy_2nd_price second generation bioenergy price (USD17MER per GJ) / 7 /
