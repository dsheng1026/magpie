...
f56_missing_message <- function(pcfg) {
  ...
  paste0(
    ...
    "  What to do: ask the MAgPIE team for the script that builds these trajectories, or for the\n",
    ...
    "  --f56=<that file>. Or build one from a MESSAGE run's own reporting with\n",
    "  messageix/optional/feedback_prep/feedback_prep.R (see feedback_prep/README.md;\n",
    "  optional, not part of the lightweight flow).\n",
